...
import financial_freedom_banner_mobile from '../../../../public/images/financial_freedom_banner_mobile.png';
import {
    ...
    <Wrapper>
      <Inner>
        ...
        <BannerCtn>
          ...
          >
            {isMobile ? (
              <Image src={financial_freedom_banner_mobile} alt="banner_img" fill />
            ) : (
